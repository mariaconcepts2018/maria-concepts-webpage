  ...
  return (
    <>
      ...
      <main className=" text-neutral-800 px-4 xl:px-8 py-12 mx-auto text-neutral-800">
          ...
          <div className="flex flex-col xl:flex-row xl:flex-wrap justify-evenly pt-4 pb-4 gap-8">

            <div className="rounded shadow-sm p-4 xl:basis-1/5 hover:shadow-lg cursor-pointer transition">
