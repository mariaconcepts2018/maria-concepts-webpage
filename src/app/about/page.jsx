...
<span className="font-bold">The Strength of Our Team: </span> At the heart of our accomplishments lies the unparalleled dedication of our staff. The synergy, trust, and loyalty within our team are what breathe life into Maria Concepts. It’s their commitment that translates our vision into reality, driving us forward each day.
...
Managing Director <br />
 ...
 <div className="flex flex-col md:flex-row justify-center gap-8">
    <div className="p-4 text-center border border-primary-600 rounded">
