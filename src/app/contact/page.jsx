  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="max-w-xl mx-auto p-6 bg-white">
      ...
      <label className="block mb-3">
        ...
        <input
          ...
          className={`mt-1 block w-full rounded border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-offset-1 ${
            errors.name ? "border-red-500 focus:ring-red-200" : "border-gray-200 focus:ring-indigo-200"
          }`}
        ...
        <input
          ...
          className={`mt-1 block w-full rounded border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-offset-1 ${
            errors.phone ? "border-red-500 focus:ring-red-200" : "border-gray-200 focus:ring-indigo-200"
          }`}
      ...
      <label className="block mb-3">
        ...
        <input
          ...
          className={`mt-1 block w-full rounded border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-offset-1 ${
            errors.email ? "border-red-500 focus:ring-red-200" : "border-gray-200 focus:ring-indigo-200"
          }`}
    ...
    <label className="block mb-3">
        ...
        <input
          ...
          className={`mt-1 block w-full rounded border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-offset-1 ${
            errors.budget ? "border-red-500 focus:ring-red-200" : "border-gray-200 focus:ring-indigo-200"
          }`}
      ...
      <label className="block mb-4">
        ...
        <textarea
          ...
          rows="5"
          className={`mt-1 block w-full rounded border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-offset-1 ${
            errors.message ? "border-red-500 focus:ring-red-200" : "border-gray-200 focus:ring-indigo-200"
          }`}
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="inline-flex items-center justify-center rounded px-4 py-2 bg-blue-600 text-white font-medium shadow hover:bg-indigo-700 disabled:opacity-60"
        >
