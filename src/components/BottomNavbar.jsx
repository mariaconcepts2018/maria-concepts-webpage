          ...
          <div className="flex h-full max-w-lg grid-cols-5 mx-auto justify-evenly">
            ...
            >
              <svg
                className={`w-6 h-6 mb-1 ${
                  pathname === "/"
                    ? "text-neutral-600 drop-shadow scale-110"
                    : "text-neutral-500"
            ...
            >
              <svg
                ...
                className={`w-6 h-6 mb-1 ${
                  pathname === "/services"
                    ? "text-neutral-600 drop-shad drop-shadow-black/30ow-xlutral-600 scale-110"
                    : "text-neutral-500"
                } group-hover:text-neutral-500 transition `}
            ...
            >
              <svg
                ...
                className={`w-6 h-6 mb-1 ${
                  pathname === "/gallery"
                    ? "text-neutral-600 scale-110 drop-shadow-black/30 drop-shadow-xl"
                    : "text-neutral-500"
                } group-hover:text-neutral-500 transition `}
                viewBox="0 0 14 14"
                fill="currentColor"
