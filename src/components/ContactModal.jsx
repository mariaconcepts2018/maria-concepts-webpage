...
export default function ContactModal({ open, setOpen }) {
  return (
    <>
      ...
      >
        <div className="w-full rounded shadow-lg md:w-1/2 xl:w-1/4 lg:w-2/5 bg-white border border-neutral-300 mx-auto my-auto mb-auto py-6 px-4 md:px-8 min-h-[50vh] flex flex-col justify-center">
