...
export default function ContactModal({ open, setOpen }) {
  ...
  return (
    <>
      <div className={`flex justify-center transition transition-duration-300 ${open? 'scale-100' : ' scale-0'} fixed inset-0 overflow-y-auto overflow-x-hidden w-screen z-500 xl:inset-x-auto`}>
